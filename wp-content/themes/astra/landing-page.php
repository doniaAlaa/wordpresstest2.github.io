...
$htmltext.='<div class="row center"  id="landigcard" style=""><br><br>
  <div class="col-sm-2" style="padding-top:95px;padding-bottom:70px;"><div class="imagebackground" style="border-width:5px;
border-style:solid;
border-color:rgba(255, 255, 255, .4); border-radius:10px;"><img src="https://wp-kashati-prod.lavaloon.com/wp-content/uploads/2021/11/ace.png" class="logodetails"></img>
</div>
</div>
  <div class="col-sm-10" >
<p style="padding-top:0px;" class="storename vertical-center" style="font-size:22px;font-weight:700px,color:white;" id="bottom">'.$posts[1]->name.'</p>
...
<p style="font-weight: 700;  font-size:15px; color:#FF1616;">Cashback: 10%</p>
